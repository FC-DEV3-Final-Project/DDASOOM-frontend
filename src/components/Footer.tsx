  ...
  return (
    <footer className="bg-[#F8F8F8] py-12">
      ...
      <div className="mx-auto flex w-full max-w-[1300px] min-w-[1000px] flex-col items-center p-5">
        {/* Footer Links - ensure this div spans the full width */}
        ...
        {/* Social Media and Copyright - ensure this div spans the full width */}
        <div className="flex w-full items-start justify-between border-t border-gray-300 pt-8">
          ...
          <div className="flex flex-col items-end">
            ...
            {/* Government Logos */}
            {/* Ensure this div spans the remaining width if needed, or adjust justify-end */}
