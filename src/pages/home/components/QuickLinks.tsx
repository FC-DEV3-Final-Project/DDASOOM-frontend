  ...
  return (
    <section className="mx-auto flex w-full max-w-[1300px] flex-col items-start gap-[80px] self-stretch bg-white/80 px-[20px] backdrop-blur-lg">
      <div className="flex flex-wrap justify-between gap-[18px]">
        <button className="inline-flex items-center justify-between gap-[14px] rounded-[100px] border-[2.5px] border-[#EAEAEA] bg-white px-[28px] py-[20px] shadow-md hover:shadow-lg focus:outline-none">
