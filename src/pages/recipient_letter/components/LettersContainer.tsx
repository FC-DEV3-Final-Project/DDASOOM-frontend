...
import ContainerHeader from '@/pages/recipient_letter/components/ContainerHeader'
import ContainerContent from '@/pages/recipient_letter/components/ContainerContent'
  ...
  useEffect(() => {
    const fetchLetters = async () => {
      ...
      if (searchQuery.trim()) {
        ...
        url = `http://koda2.elementsoft.biz:8081/recipientLetters/search?${params.toString()}`
      } else {
        url = `http://koda2.elementsoft.biz:8081/recipientLetters?${params.toString()}`
      }
